...
def fullpath(rel):
    return os.path.abspath(os.path.join(SITE_ROOT, rel))
...
DATABASES = {
    'default': {
        ...
        'NAME': fullpath('project/scratchpad.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '*f3af8^dq)jqh4)38hs*82(n@0u5_e6j#!455o)z+4jt6iqae*'
